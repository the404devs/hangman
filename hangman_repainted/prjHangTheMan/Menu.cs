    ...
    public partial class Menu : Form
    {
        ...
        ******************************************/
        ...
        void toggleMusic()
        {
            if (Game.music == true)
            {
                pbMusic.Image = Hangman2CC.Properties.Resources.musicoff;
                Game.music = false;
                player.Stop();//Stop the music
            }
            else
            {
                pbMusic.Image = Hangman2CC.Properties.Resources.musicon;
                Game.music = true;
        ...
        ************************************************************************/
        ...
        {
            lblPlay.BackColor = Color.Teal;            
        }

        private void lblPlay_MouseLeave(object sender, EventArgs e)
        {
            lblPlay.BackColor = Color.Turquoise;
        }
        ...
        *********************/
        ...
        {
            MessageBox.Show("Hangman 2: Classic Comeback Version 3.1: Repainted Edition\nCreated By: Kevin, Owen, and Jatin\n11/05/17");//Show the creators of the game 
        }

        private void visitWebsiteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start("http://sdsscomputers.com/GoodwinOwen/ASSIGNMENTS/COMPLETED/Unit4Assignment/index.html");//Opens our website
        }

        private void scoringInfoToolStripMenuItem_Click(object sender, EventArgs e)
        {
