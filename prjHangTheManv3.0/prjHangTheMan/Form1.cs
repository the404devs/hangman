...
namespace prjHangTheMan
{
    public partial class Game : Form
    {
        ...
        ***********************************************************/
        ...
        private void lblMenu_Click(object sender, EventArgs evnt)//The "Menu" button
        {
        ...
        *****************************************************************/
        ...
        private void lblMenu_MouseEnter(object sender, EventArgs evnt)
        {
            lblMenu.BackColor = Color.Gray;
        }

        private void lblMenu_MouseLeave(object sender, EventArgs evnt)
        {
            lblMenu.BackColor = Color.FromArgb(42, 49, 50);
        }

        private void lblContinue_MouseEnter(object sender, EventArgs e)
        {
            lblContinue.BackColor = Color.Gray;
        }

        private void lblContinue_MouseLeave(object sender, EventArgs e)
        {
            lblContinue.BackColor = Color.FromArgb(42, 49, 50);
        }
        ...
        private void lblA_MouseEnter(object sender, EventArgs evnt)
        {
            ...
            lblA.BackColor = Color.DeepSkyBlue;
        }
